...
function TransferToken({ isEthAddress }) {
  ...
  const TransferTokenHandler = () => {
    ...
    if (reciepentEhtAddress == "" && tokenAmount <= 0) {
     ...
     if (!validAddress || !reciepentEhtAddress) {
      setError(true)
      setInvalidRecipientAddress(true)
      return
    }
  ...
  return (
    <>
      ...
      <Box width={1} mt={2} sx={{ marginTop: "22px", bgcolor: '#F4F6F8', borderRadius: "12px", boxShadow: "0px 2px 5px 0px rgba(0, 0, 0, 0.30)" }} borderRadius={5}  mb={7} height={"auto"} >
